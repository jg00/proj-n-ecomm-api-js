...
require("express-async-errors"); // allow us to throw instead of trycatch in async controllers
...
app.use(errorHandlerMiddleware); // invoked only from existing route
